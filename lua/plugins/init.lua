return {
  ...
  { import = "plugins.gale.crates", enabled = false },
  ...
  { import = "plugins.gale.gleam", enabled = false },
  -- https://github.com/smoka7/hop.nvim
  { import = "plugins.gale.hop" },
  ...
  --
  { import = "plugins.gale.treesitter-textobjects" },
  ...
  { import = "plugins.gale.rustaceanvim", enabled = false },
